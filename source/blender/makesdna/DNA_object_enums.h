...
#define OB_MODE_ALL_PAINT_CURVES \
  (OB_MODE_SCULPT_CURVES | OB_MODE_WEIGHT_CURVES)

/** Any mode that uses Object.sculpt. */
#define OB_MODE_ALL_SCULPT (OB_MODE_SCULPT | OB_MODE_VERTEX_PAINT | OB_MODE_WEIGHT_PAINT)

/** Any mode that uses weight-paint. */
#define OB_MODE_ALL_WEIGHT_PAINT (OB_MODE_WEIGHT_PAINT | OB_MODE_WEIGHT_GREASE_PENCIL | OB_MODE_WEIGHT_CURVES)
